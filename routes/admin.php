...
|--------------------------------------------------------------------------
|
| These routes were originally defined in web.php under an auth/verified
| middleware group. They are moved here to keep the front (public) routes
| separate. The file is required from web.php so the behaviour does not
| change.
|
*/
...
Route::middleware(['auth', 'verified', 'admin'])->group(function () {
    ...
    Route::delete('/Officers/bulk-delete', [OfficerController::class, 'bulkDestroy'])->name('Admin.Officers.bulkDestroy');
